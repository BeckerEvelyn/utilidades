        ...
        child: StreamBuilder<List<AlunosModel>>(
          ...
          builder: (context, snapshot){
            ...
            if(!snapshot.hasData || snapshot.data!.isEmpty){
              return const Center(
                child: Text("Nenhu dado encontrado"),
              );
            }
            ...
            return ListView.builder(
              ...
              return ListTile(
                ...
                subtitle: Text("Idade: ${aluno.idade} | Turma: ${aluno.turma}"),
                trailing: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    IconButton(onPressed: () => _abrirDialog(aluno: aluno), icon: Icon(Icons.edit)),
                    IconButton(onPressed: () => _controller.deletarAluno(aluno.id,), icon: Icon(Icons.delete)),
                  ],
                ),
              );
              }
