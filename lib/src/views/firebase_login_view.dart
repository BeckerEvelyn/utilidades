      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            //botão ou loading
            _loading ? const CircularProgressIndicator() : ElevatedButton(onPressed: () => {}, child: Text("Entrar")),
            TextButton(onPressed: _abrirCadastro, child: const Text("Não tem conta? Cadastre-se")),
          ],
        ),
       ),
      ),
